...
const upadateUserAvatar = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(
            new ApiResponse(200, {}, "Avatar Image Update successfully")
        )

})

const upadateUsercoverImages = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(
            new ApiResponse(200, {}, "Cover Image Update successfully")
        )
...
export { registerUser, loginUser, logoutUser, refreshAccessToken, changeCurrentPassword, getCurrentUser, updateAccountDetails, upadateUserAvatar, upadateUsercoverImages, getUserChannelProfile ,getWatchHistory };